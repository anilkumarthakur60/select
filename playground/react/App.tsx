    ...
    <main style={themeStyle}>
      <header>
        <div className="brand">
          ...
          <h1>@anilkumarthakur/select · React</h1>
  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      [style*='#0b1220'] .card { background: rgba(30, 41, 59, 0.4); border-color: rgba(255, 255, 255, 0.08); }
      ...
      [style*='#0b1220'] .card pre { background: rgba(255, 255, 255, 0.04); }
